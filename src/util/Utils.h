...
class Utils {
 ...
 public:
    ...
    static void replaceValue(json& j, const std::string& oldVal, const std::string& newVal);
    static bool isValidJson(const std::string& str);
    static void unescapeNestedJson(json& j);
    ...
    bool sendPiplinedQueryPlanToWorker(std::string host, int port, std::string masterIP, int graphID, int partitionId,
