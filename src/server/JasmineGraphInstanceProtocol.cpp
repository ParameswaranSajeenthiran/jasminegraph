...
const string JasmineGraphInstanceProtocol::PIPELINED_QUERY_START = "pipelined-query-start";
...
const string JasmineGraphInstanceProtocol::PIPELINED_QUERY_START_ACK = "pipelined-query-start-ack";
